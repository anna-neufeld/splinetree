...
Our key motivation in building a spline forest was to figure out which variables are most importantly associated with heterogeneity in BMI trajectory. The ``splinetree`` package implements a variable importance metric closely related to that of @breiman2002random and @liaw2002classification.
