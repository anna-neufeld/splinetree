...
Each of these ``splineforest`` objects is a named list with 16 components.
...
Our primary motivation in building forests of spline trees is to obtain stable measures of variable importance using permutation importance. 
